    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Row(
            // * Membuat textnya jadi kebawah
            crossAxisAlignment: CrossAxisAlignment.end,
            children: [
              BigText(text: "Recommended"),
              SizedBox(width: Dimensions.width10),
              Container(
                //* Membuat agar agak ke tengah
        ...
        //* Membuat list dari recommended makanan
        GetBuilder<RecommendedProductController>(
          builder: (recommendeedProduct) {
            return recommendeedProduct.isLoaded
                ? ListView.builder(
                    physics: NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    itemCount:
                        recommendeedProduct.recommendedProductList.length,
